...
proc create_root_design { parentCell } {
  ...
  # Create instance: gnd_1b, and set properties
  set gnd_1b [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 gnd_1b ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
   CONFIG.CONST_WIDTH {1} \
 ] $gnd_1b

  # Create instance: pl_irq_gen_0, and set properties
  set block_name pl_irq_gen
  set block_cell_name pl_irq_gen_0
  if { [catch {set pl_irq_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pl_irq_gen_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins pl_irq_gen_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net gnd_1b_dout [get_bd_pins gnd_1b/dout] [get_bd_pins processing_system7_0/ENET1_EXT_INTIN]
  connect_bd_net -net pl_irq_gen_0_irq [get_bd_pins pl_irq_gen_0/irq] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins pl_irq_gen_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_inv/Op1] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_inv_Res [get_bd_pins gmii_to_rgmii_0/rx_reset] [get_bd_pins gmii_to_rgmii_0/tx_reset] [get_bd_pins rst_inv/Res]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins pl_irq_gen_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pl_irq_gen_0/s_axi/reg0] SEG_pl_irq_gen_0_reg0
